...
Los viajes con `is_public = true` aparecen a usuarios autenticados aunque no sean miembros, pero RLS solo expone la cabecera, el itinerario publico y restaurantes. El duplicado desde acceso publico crea una copia privada sin vuelos, alojamientos, coches, actividades con reserva, seguros, documentos, contactos, diario ni gastos.
